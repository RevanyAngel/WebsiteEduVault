document.addEventListener('DOMContentLoaded', function () {
    ...
    const newReleaseBooks = [
        { title: 'Belajar HTML dan CSS', author: 'Rian Ariona', img: 'cover buku_belajar HTML & CSS.jpg', pdf:'Belajar HTML dan CSS.pdf' },
        { title: 'Database MySQL', author: 'Abdul Kadir', img: 'cover buku_Tuntunan Praktis Belajar Database.avif' },
        ...
        { title: 'ALjabar Linear Dasar', author: 'Qurrotul Aini', img: 'cover buku_aljabar linear dasar.jpeg' },
        { title: 'Rekayasa Perangkat Lunak', author: 'Rosa A.S', img: 'CB_RPL.jpeg' },
        { title: 'Pemrograman Robot', author: 'Taufiq Dwi', img: 'CB_Pemrograman Robot.jpg' }
    ];
    ...
    const trendingBooks = [
        ...
        { title: 'Rancang Bangun Aplikasi Manajemen Kos', author: 'Daris Irfan Putrawanto', img: 'F.png', pdf:'6.pdf' },
        { title: 'Pengantar Metode Numerik', author: 'Dr. Elis Ratna Wulan', img: 'cover buku_pengantar metode numerik.jpg' },
        { title: 'Penerapanan Model Deteksi Objek Untuk Robot', author: 'Ilham Rizqyakbar', img: 'E.png', pdf:'5.pdf' }
    ];
